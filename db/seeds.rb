...
author = User.new(email: 'faker@test.com', password: 'aassdd', password_confirmation: 'aassdd',
...
10.times do
  ...
  4.times do
    task = category.tasks.build(title: Faker::Job.title, description: Faker::Lorem.paragraph, address: Faker::Address.full_address, author: author, user: user)
    3.times do
      employee = Employee.new(name: Faker::Name.female_first_name, email: Faker::Internet.email)
